...
public final class SystemConst {
    ...
    public static final Integer TIME_REDIS =30*60;
    public static final Integer CODE_EXPIRE =1*60;

    public  static final  String  MAIL_FROM="1793814895@qq.com";
    public  static final  String  MAIL_PASSWORD="iyefqfzdbnnycjfd";
    ...
    public  static final  String  SESSIONID="fh_ID";

    public  static final  String  DOMAIN="shop.fh.com";
